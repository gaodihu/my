  ...
  <tr>
    <td bgcolor="#f1f1f1">
      <table width="700" align="center" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="padding:12px 0px;">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="143"><a href="www.moresku.com"><img src="<?php echo $store_url;?>image/email/elogo.jpg" width="143" height="79" /></a></td>
        ...
        <tr>
          <td width="698" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333; border:1px solid #dcdcdc; padding:15px 20px; line-height:24px; background-color:#fff;"><?php echo $text_order_welcome;?>
