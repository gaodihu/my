...
<input type="hidden" name="payCountrycode" value="<?php echo $order['shipping_iso_code_2']; ?>" />

<input type="hidden" name="ebanxName" value="<?php echo $order['shipping_firstname'] . ' ' .$order['shipping_lastname'] ; ?>" />
<input type="hidden" name="ebanxEmail" value="<?php echo $order['email']; ?>" />
<input type="hidden" name="ebanxTypeCode" value="boleto" />
