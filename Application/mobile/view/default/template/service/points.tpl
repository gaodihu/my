	...
	<div class="points-content">
		...
		<ul class="points-list clearfix">
			<li>
				...
				<img src="/catalog/view/theme/default/images/points/img1.png" />
			...
			<li >
				...
				<img src="/catalog/view/theme/default/images/points/img2.png" />
			...
			<li >
				...
				<img src="/catalog/view/theme/default/images/points/img3.png" />
				<div class="p-con-tit">** <?php echo $text_6;?></div>
		...
		<div class="points-msg">
			...
			<p class="points-img-right"><img src="/catalog/view/theme/default/images/points/points_<?php echo strtolower($this->session->data['language']);?>.jpg" /></p>
