...
<section class="tanchuan checkout_tc">
    <?php if($logged) { ?><div class="checkout_con enter_new closebtn"><a class="btn"></a></div><?php } ?>
    <div class="tanchuang_box">
        ...
        <form enctype="multipart/form-data" method="post" id="add_address_from">
            <div class="form selectform">
                <ul>
                    <li class="text"><span class="left">* <?php echo $entry_firstname;?>  </span><input name="firstname" type="text" value="<?php echo $address_info['firstname'];?>" verify="user"/></li>
                    <li class="text"><span class="left">*<?php echo $entry_lastname;?> </span><input name="lastname" type="text" value="<?php echo $address_info['lastname'];?>" verify="user"/></li>

                    <?php if(!$logged) { ?>
                    <li class="text"><span class="left">* <?php echo $entry_email;?>  </span><input name="email" type="text" value="<?php echo $guest_email;?>" verify="email"/></li>
                    <?php } ?>
                    ...
                    <li class="text"><span class="left">* <?php echo $entry_address_1;?></span><input name="address_1" type="text" value="<?php echo $address_info['address_1'];?>" verify="address"/></li>
                    ...
                    <li class="text"><span class="left">*  <?php echo $entry_city;?></span><input name="city" type="text" value="<?php echo $address_info['city'];?>" verify="city"/></li>
                    <li class="text"><span class="left">*  <?php echo $entry_country;?></span>
                    ...
                    <li class="text"><span class="left add-must-tag">* <?php echo $entry_zone;?></span>
                    ...
                    <li class="text"><span class="left">* <?php echo $entry_postcode;?></span><input name="postcode" type="text" value="<?php echo $address_info['postcode'];?>" verify="postcode"/></li>
                    <li class="text"><span class="left">* <?php echo $entry_phone;?></span><input name="phone" type="text"  value="<?php echo $address_info['phone'];?>" verify="number"/></li>
        ...
        <form enctype="multipart/form-data" method="post" id="add_address_from">
            <div class="form selectform">
                <ul>
                    <li class="text"><span class="left">* <?php echo $entry_firstname;?>  </span><input name="firstname" type="text" value="" verify="user"/></li>
                    <li class="text"><span class="left">* <?php echo $entry_lastname;?>  </span><input name="lastname" type="text" value="" verify="user"/></li>
                    <?php if(!$logged) { ?>
                        <li class="text"><span class="left">* <?php echo $entry_email;?>  </span><input name="email" type="text" value="" verify="email"/></li>
                    <?php } ?>
                    ...
                    <li class="text"><span class="left">* <?php echo $entry_address_1;?></span><input name="address_1" type="text" value="" verify="address"/></li>
                    <li class="text"><span class="left"> <?php echo $entry_address_2;?></span><input name="address_2" type="text" value="" verify="address"/></li>
                    <li class="text"><span class="left">* <?php echo $entry_city;?> </span><input name="city" type="text" value="" verify="city"/></li>
                    <li class="text"><span class="left">* <?php echo $entry_country;?> </span>
                        <select name="country_id"  class="large-field" verify="notnull">
                            <option value=""><?php echo $text_select; ?></option>
                            <?php foreach ($countries as $country) { ?>
                    ...
                    <li class="text"><span class="left">* <?php echo $entry_postcode;?> </span><input name="postcode" type="text" value="" verify="postcode"/></li>
                    <li class="text"><span class="left">* <?php echo $entry_phone;?></span><input name="phone" type="text" verify="number"/></li>
