...
<body>
    ...
    <form action="<?php echo $action;?>" method="post" enctype="add_address_from" id='order_form'>
        <div class="width990">
            ...
            <div class="subtoal" id='order_subtoal'>
                <?php include_once(DIR_TEMPLATE.'/default-horizontal/template/checkout/include/order_subtoal.tpl');?>
            </div>
    ...
    <div id='address_form'>
        <?php include_once(DIR_TEMPLATE.'/default-horizontal/template/checkout/include/shipping_address_from.tpl');?>
    </div>
