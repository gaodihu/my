...
//confim
$_['text_subject_confim']        = 'Confirmación de Registro';
$_['text_main_content_confim']        = '<span style="font-size:24px; line-height:50px; font-weight:bold;">Estimado cliente,</span><br/>Por favor confirme su dirección de E-mail con este <a style="color:#0092cd; text-decoration:underline;" href="%s">confirmación link</a>, que es válido sólo una vez en 24 horas.<br/><br/>
Al iniciar sesión en su cuenta, usted será capaz de hacer las siguientes cosas:<br/><br/>
– Proceder a través de compra más rápidamente al hacer una compra;<br/> 
– Revise el progreso de los pedidos ;<br/>
– Ver historial de pedidos;<br/>
– Modificar la información de su cuenta ;<br/>
– Cambiar su contraseña ;<br/>
– Direcciones alternativas tienda (para el envío a múltiples miembros de la familia y los amigos!) ;<br/>
