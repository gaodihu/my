...
$_['text_review_posting_guidelines']="<h4>Review Posting Guidelines</h4>
                MoreSKU read all reviews before posting them and may reject some reviews if they don't follow the guidelines.
...
$_['text_review_order_number_note']="Your order number should be include this product.";
$_['error_order_number']="Please enter a right order number.";
