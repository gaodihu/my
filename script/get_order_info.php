...
//require_once("D://XAMPP/htdocs/new_myled/script/conf2.php");
...
function get_order_info(){
    ...
    where o.send_forecast_status =1 and os.name='Processing' and os.language_id=1";
    ...
    function get_detail_sales_csv($order_info){
        ...
        $file ='/home/www/new_myled.com/script/test_detail_sale_order.csv';
    ...
    function get_sale_csv($order_info){
        ...
        $file ='/home/www/new_myled.com/script/test_sale_order.csv';
        $fp = fopen($file, 'w+');
        chmod($file, 0777);
    ...
    function get_pur_order_csv($order_info){
        ...
        $file ='/home/www/new_myled.com/script/test_purchase_order.csv';
        $fp = fopen($file, 'w+');
        chmod($file, 0777);
