            <ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="index.php/f_catagory/add">
					Add a faq catagory
				</a></li>
			...
			<div class="content-box" style="height:600px;"><!-- Start Content Box -->
                ...
                <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<?php } ?>
                      <form action='index.php/f_catagory/all_del' method='post' enctype="multipart/form-data" id='list_form'>
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="index.php/f_catagory/update?id=<?php echo $catagory['catagory_id'];?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                                          <a href="javascript:Delete('index.php/f_catagory/delete?id=<?php echo $catagory['catagory_id'];?>')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
									</td>
								</tr>
                                ...
                                <tr class="none cat_catagory<?php echo $catagory['catagory_id'];?>">
									...
									<td>
										<!-- Icons -->
										 <a href="index.php/f_catagory/update?id=<?php echo $child_cat['catagory_id'];?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                                        <a href="javascript:Delete('index.php/f_catagory/delete?id=<?php echo $child_cat['catagory_id'];?>')" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
									</td>
								</tr>
