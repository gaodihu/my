...
<body>
	<form method="post" enctype="multipart/form-data" action="/edm.php?act=upload"  id='edm_upload_form'>
		<table width="1000" border="1" bgcolor="#339966" id='upload_table'>
		   <tr><td colspan="2" align="center">EDM邮件模板</td></tr>
			<tr>
					<td>选择模板类型</td>
					<td><input type="radio" name='temple_type' value='1' style="width:20px;"/>1号模板(1行4个商品)
							<input type="radio" name='temple_type' value='2' style="width:20px;"/>2号模板(1行3个商品)
					</td>
				</tr>
