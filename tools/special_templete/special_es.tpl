...
<div>
		...
		<div class="page">
			<div  class="header">
				...
				<ul>
					<li><a href="http://es.myled.com/new_arrivals.html">Nuevos ingresos</a></li>
					<li>|</li>
					<li><a href="http://es.myled.com/top-sellers.html">Los mejores vendedores</a></li>
					<li>|</li>
					<li><a href="http://es.myled.com/deals.html">Ofertas</a></li>
					<li>|</li>
					<li><a href="http://es.myled.com/clearance.html">Liquidación</a></li>
				</ul>
				<a href="http://es.myled.com/" alt="MyLED.com" target="_blank"><div class="logo"></div></a>
			</div>
		</div>
        <!-- header -->
        <div class="banner">
	...
	?>
  					<a href="http://es.myled.com/<?php echo $value['url'];?>"><img src="<?php echo $value['img'];?>"></a> 
					<a class="name" href="http://es.myled.com/<?php echo $value['url'];?>"><?php echo $value['name'];?></a>

					<p class="price"><?php echo $value['special_price'];?>€<span class="yj"><?php echo $value['price'];?>€</span></p>
					<a class="buy" href="http://es.myled.com/<?php echo $value['url'];?>">Compre Ahora</a>
		</li>	
	<?php } ?>
	<?php } ?>
	 </ul>
...
<div class="clear"></div>
    ...
    <div class="footerup page">
        <div class="about"><h2>Info de la compañía</h2><p><a href="http://es.myled.com/about-us.html" target="_blank">Sobre nosotros</a></p><p><a href="http://es.myled.com/contact-us.html" target="_blank">Contáctenos</a></p></div>
    <div class="about"><h2>Servicio al cliente</h2><p><a href="http://es.myled.com/accepted-payment-methods.html" target="_blank">Metodos de pago aceptados</a></p><p><a href="http://es.myled.com/return-policy.html" target="_blank">Política de devolución</a></p><p><a href="http://es.myled.com/secure-shopping.html" target="_blank">Compra segura</a></p><p><a href="http://es.myled.com/shipping-methods.html">Métodos de envío</a></p></div>
    <div class="about"><h2>Importante</h2><p><a href="http://es.myled.com/privacy-policy.html" target="_blank">Política de privacidad</a></p><p><a href="http://es.myled.com/terms-and-conditions.html" target="_blank">Términos y condiciones</a></p><p><a href="http://es.myled.com/tax-policy.html" target="_blank">Política de Impuestos</a></p></div>    
    <div class="about"><h2>asociación</h2><p><a href="http://es.myled.com/affiliate-marketing.html" target="_blank">Mercadeo afiliado</a></p><p><a href="http://es.myled.com/affiliates-terms-of-use.html" target="_blank">Términos de uso de afiliados</a></p></div>
        <div class="share">
        ...
        <!-- footer -->
        <footer>
            <div class="page">Copyright © 2014 Hong Kong MyLED Group Stock Limited. Derechos reservados. </div>
        </footer>
</div>
...
$(document).ready(function () {
	...
	$inp.keypress(function (e) { //这里给function一个事件参数命名为e，叫event也行，随意的，e就是IE窗口发生的事件。
		...
		if (key == 13) {
			url =  'http://es.myled.com/index.php?route=product/search';
