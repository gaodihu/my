...
<div>
		...
		<div class="page">
			<div  class="header">
				...
				<ul>
					<li><a href="http://it.myled.com/new_arrivals.html">Nuovi Arrivi</a></li>
					<li>|</li>
					<li><a href="http://it.myled.com/top-sellers.html">Più Venduti</a></li>
					<li>|</li>
					<li><a href="http://it.myled.com/deals.html">Offerte</a></li>
					<li>|</li>
					<li><a href="http://it.myled.com/clearance.html">Svendita</a></li>
				</ul>
				<a href="http://it.myled.com/" alt="MyLED.com" target="_blank"><div class="logo"></div></a>
			</div>
		</div>
        <!-- header -->
        <div class="banner">
	...
	?>
  					<a href="http://it.myled.com/<?php echo $value['url'];?>"><img src="<?php echo $value['img'];?>"></a> 
					<a class="name" href="http://it.myled.com/<?php echo $value['url'];?>"><?php echo $value['name'];?></a>

					<p class="price"><?php echo $value['special_price'];?>€<span class="yj"><?php echo $value['price'];?>€</span></p>
					<a class="buy" href="http://it.myled.com/<?php echo $value['url'];?>">Ordina ora</a>
		</li>	
	<?php } ?>
	<?php } ?>
	 </ul>
...
<div class="clear"></div>
    ...
    <div class="footerup page">
        <div class="about"><h2>Info Azienda</h2><p><a href="http://it.myled.com/about-us.html" target="_blank">Chi Siamo</a></p><p><a href="http://it.myled.com/contact-us.html" target="_blank">Contattaci</a></p></div>
    <div class="about"><h2>Servizio Clienti</h2><p><a href="http://it.myled.com/accepted-payment-methods.html" target="_blank">Metodi di Pagamento Accettati</a></p><p><a href="http://it.myled.com/return-policy.html" target="_blank">Politica sulle Restituzioni</a></p><p><a href="http://it.myled.com/secure-shopping.html" target="_blank">Acquista in Sicurezza</a></p><p><a href="http://it.myled.com/shipping-methods.html">Metodi di spedizione</a></p></div>
    <div class="about"><h2>Importante</h2><p><a href="http://it.myled.com/privacy-policy.html" target="_blank">Politica sulla Privacy</a></p><p><a href="http://it.myled.com/terms-and-conditions.html" target="_blank">Termini e Condizioni</a></p><p><a href="http://it.myled.com/tax-policy.html" target="_blank">Politica sulle Tasse</a></p></div>    
    <div class="about"><h2>Collaborazione</h2><p><a href="http://it.myled.com/affiliate-marketing.html" target="_blank">Affiliate Marketing</a></p><p><a href="http://it.myled.com/affiliates-terms-of-use.html" target="_blank">Termini di Utilizzo Affiliati</a></p></div>
        <div class="share">
        ...
        <!-- footer -->
        <footer>
            <div class="page">Copyright © 2014 Hong Kong MyLED Group Stock Limited. Tutti i Diritti Riservati.</div>
        </footer>
</div>
...
$(document).ready(function () {
	...
	$inp.keypress(function (e) { //这里给function一个事件参数命名为e，叫event也行，随意的，e就是IE窗口发生的事件。
		...
		if (key == 13) {
			url =  'http://it.myled.com/index.php?route=product/search';
