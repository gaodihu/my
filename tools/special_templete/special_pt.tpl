...
<div>
		...
		<div class="page">
			<div  class="header">
				...
				<ul>
					<li><a href="http://pt.myled.com/new_arrivals.html">Novas Entradas</a></li>
					<li>|</li>
					<li><a href="http://pt.myled.com/top-sellers.html">Mais Vendidos</a></li>
					<li>|</li>
					<li><a href="http://pt.myled.com/deals.html">Transações</a></li>
					<li>|</li>
					<li><a href="http://pt.myled.com/clearance.html">Folga</a></li>
				</ul>
				<a href="http://pt.myled.com/" alt="MyLED.com" target="_blank"><div class="logo"></div></a>
			</div>
		</div>
        <!-- header -->
        <div class="banner">
	...
	?>
  					<a href="http://pt.myled.com/<?php echo $value['url'];?>"><img src="<?php echo $value['img'];?>"></a> 
					<a class="name" href="http://pt.myled.com/<?php echo $value['url'];?>"><?php echo $value['name'];?></a>

					<p class="price"><?php echo $value['special_price'];?>€<span class="yj"><?php echo $value['price'];?>€</span></p>
					<a class="buy" href="http://pt.myled.com/<?php echo $value['url'];?>">Compre Agora</a>
		</li>	
	<?php } ?>
	<?php } ?>
	 </ul>
...
<div class="clear"></div>
    ...
    <div class="footerup page">
        <div class="about"><h2>Informações da Companhia</h2><p><a href="http://pt.myled.com/about-us.html" target="_blank">Sobre Nós</a></p><p><a href="http://pt.myled.com/contact-us.html" target="_blank">Entre em Contato</a></p></div>
    <div class="about"><h2>Atendimento ao Cliente</h2><p><a href="http://pt.myled.com/accepted-payment-methods.html" target="_blank">Formas de pagamento aceites</a></p><p><a href="http://pt.myled.com/return-policy.html" target="_blank">Politica de Devoluções</a></p><p><a href="http://pt.myled.com/secure-shopping.html" target="_blank">Compras Seguras</a></p><p><a href="http://pt.myled.com/shipping-methods.html">Formas de Envio</a></p></div>
    <div class="about"><h2>Importante</h2><p><a href="http://pt.myled.com/privacy-policy.html" target="_blank">Politica de Privacidade</a></p><p><a href="http://pt.myled.com/terms-and-conditions.html" target="_blank">Termos e Condições</a></p><p><a href="http://pt.myled.com/tax-policy.html" target="_blank">Política Fiscal</a></p></div>    
    <div class="about"><h2>Parcerias</h2><p><a href="http://pt.myled.com/affiliate-marketing.html" target="_blank">Marketing Afiliado</a></p><p><a href="http://pt.myled.com/affiliates-terms-of-use.html" target="_blank">Termos de utilização para Afiliados</a></p></div>
        <div class="share">
        ...
        <!-- footer -->
        <footer>
            <div class="page">Copyright © 2014 Hong Kong MyLED Group Stock Limited. All Rights Reserved.</div>
        </footer>
</div>
...
$(document).ready(function () {
	...
	$inp.keypress(function (e) { //这里给function一个事件参数命名为e，叫event也行，随意的，e就是IE窗口发生的事件。
		...
		if (key == 13) {
			url =  'http://pt.myled.com/index.php?route=product/search';
