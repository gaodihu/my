...
<body>
	<form method="post" enctype="multipart/form-data" action="/special.php?act=upload">
		<table width="1000" border="1" bgcolor="#339966" id='upload_table'>
				...
				<tr><td>【en】sku:</td><td><input type='text' name='pro_sku[en]'></td></tr>
				<tr><td>【de】sku:</td><td><input type='text' name='pro_sku[de]'></td></tr>
				<tr><td>【es】sku:</td><td><input type='text' name='pro_sku[es]'></td></tr>
				<tr><td>【fr】sku:</td><td><input type='text' name='pro_sku[fr]'></td></tr>
				<tr><td>【it】sku:</td><td><input type='text' name='pro_sku[it]'></td></tr>
		</table>
