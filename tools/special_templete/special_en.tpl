...
<div>
		...
		<div class="page">
			<div  class="header">
				...
				<ul>
					<li><a href="http://www.myled.com/new_arrivals.html">New Arrivals</a></li>
					<li>|</li>
					<li><a href="http://www.myled.com/top-sellers.html">Top Sellers</a></li>
					<li>|</li>
					<li><a href="http://www.myled.com/deals.html">Deals</a></li>
					<li>|</li>
					<li><a href="http://www.myled.com/clearance.html">Clearance</a></li>
				</ul>
				<a href="http://www.myled.com/" target="_blank"><div class="logo"></div></a>
			</div>
		</div>
        <!-- header -->
        <div class="banner">
	...
	?>
  					<a href="http://www.myled.com/<?php echo $value['url'];?>"><img src="<?php echo $value['img'];?>"></a> 
					<a class="name" href="http://www.myled.com/<?php echo $value['url'];?>"><?php echo $value['name'];?></a>

					<p class="price">$<?php echo $value['special_price'];?><span class="yj">$<?php echo $value['price'];?></span></p>
					<a class="buy" href="http://www.myled.com/<?php echo $value['url'];?>">Buy Now</a>
		</li>	
	<?php } ?>
	<?php } ?>
	 </ul>
...
<div class="clear"></div>
    ...
    <div class="footerup page">
        <div class="about"><h2>Company Info</h2><p><a href="http://www.myled.com/about-us.html" target="_blank">About Us</a></p><p><a href="http://www.myled.com/contact-us.html" target="_blank">Contact Us</a></p></div>
        <div class="about"><h2>Customer Service</h2><p><a href="http://www.myled.com/accepted-payment-methods.html" target="_blank">Accepted Payment Methods</a></p><p><a href="http://www.myled.com/return-policy.html" target="_blank">Return Policy</a></p><p><a href="http://www.myled.com/secure-shopping.html" target="_blank">Secure Shopping</a></p><p><a href="http://www.myled.com/shipping-methods.html">Shipping Methods</a></p></div>
        <div class="about"><h2>Important</h2><p><a href="http://www.myled.com/privacy-policy.html" target="_blank">Privacy Policy</a></p><p><a href="http://www.myled.com/terms-and-conditions.html" target="_blank">Terms and Conditions</a></p></div>
        <div class="about"><h2>Partnership</h2><p><a href="http://www.myled.com/affiliate-marketing.html" target="_blank">Affiliate Marketing</a></p><p><a href="http://www.myled.com/affiliates-terms-of-use.html" target="_blank">Affiliates Terms of Use</a></p></div>
        <div class="share">
