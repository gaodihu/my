...
<div>
		...
		<div class="page">
			<div  class="header">
				...
				<ul>
					<li><a href="http://fr.myled.com/new_arrivals.html">Nouveautés</a></li>
					<li>|</li>
					<li><a href="http://fr.myled.com/top-sellers.html">Meilleures Ventes</a></li>
					<li>|</li>
					<li><a href="http://fr.myled.com/deals.html">Offres</a></li>
					<li>|</li>
					<li><a href="http://fr.myled.com/clearance.html">Liquidation</a></li>
				</ul>
				<a href="http://fr.myled.com/" alt="MyLED.com" target="_blank"><div class="logo"></div></a>
			</div>
		</div>
        <!-- header -->
        <div class="banner">
	...
	?>
  					<a href="http://fr.myled.com/<?php echo $value['url'];?>"><img src="<?php echo $value['img'];?>"></a> 
					<a class="name" href="http://fr.myled.com/<?php echo $value['url'];?>"><?php echo $value['name'];?></a>

					<p class="price"><?php echo $value['special_price'];?>€<span class="yj"><?php echo $value['price'];?>€</span></p>
					<a class="buy" href="http://fr.myled.com/<?php echo $value['url'];?>">Commandez Ici</a>
		</li>	
	<?php } ?>
	<?php } ?>
	 </ul>
...
<div class="clear"></div>
    ...
    <div class="footerup page">
        <div class="about"><h2>Info Société</h2><p><a href="http://fr.myled.com/about-us.html" target="_blank">A Propos</a></p><p><a href="http://fr.myled.com/contact-us.html" target="_blank">Contactez-nous</a></p></div>
    <div class="about"><h2>Problème service client</h2><p><a href="http://fr.myled.com/accepted-payment-methods.html" target="_blank">Modes de paiement acceptés</a></p><p><a href="http://fr.myled.com/return-policy.html" target="_blank">Politique de retour</a></p><p><a href="http://fr.myled.com/secure-shopping.html" target="_blank">Shopping sécurisé</a></p><p><a href="http://fr.myled.com/shipping-methods.html">Modes de livraison</a></p></div>
    <div class="about"><h2>Important</h2><p><a href="http://fr.myled.com/privacy-policy.html" target="_blank">Vie privée</a></p><p><a href="http://fr.myled.com/terms-and-conditions.html" target="_blank">Termes et conditions</a></p><p><a href="http://fr.myled.com/tax-policy.html" target="_blank">Réglementation douanière</a></p></div>    
    <div class="about"><h2>Partenariat</h2><p><a href="http://fr.myled.com/affiliate-marketing.html" target="_blank">Marketing d'affiliation</a></p><p><a href="http://fr.myled.com/affiliates-terms-of-use.html" target="_blank">Conditions des Affiliés</a></p></div>
        <div class="share">
        ...
        <!-- footer -->
        <footer>
            <div class="page">Copyright © 2014 Hong Kong MyLED Group Stock Limited. Tous Droits Réservés.</div>
        </footer>
</div>
...
$(document).ready(function () {
	...
	$inp.keypress(function (e) { //这里给function一个事件参数命名为e，叫event也行，随意的，e就是IE窗口发生的事件。
		...
		if (key == 13) {
			url =  'http://fr.myled.com/index.php?route=product/search';
