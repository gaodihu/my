...
class ControllerCatalogInformation extends Controller { 
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_information_group'])) {
				$filter['filter_information_group'] = $this->request->get['filter_information_group'];
		} else {
				$filter['filter_information_group']= null;
		}
		if (isset($this->request->get['sort'])) {
		...
		foreach ($results as $result) {
            ...
            $information_group =$this->model_catalog_information_group->getInformationGroup($result['information_group_id']);
			$this->data['informations'][] = array(
				'information_id' => $result['information_id'],
                'information_group_code'     => $information_group['information_group_code'],
        ...
        $this->data['sort_information_id'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'] . '&sort=i.information_id' . $url, 'SSL');
		$this->data['sort_information_group_id'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'] . '&sort=i.information_group_id' . $url, 'SSL');
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['information_group_id'])) {
			...
			$this->data['information_group_id'] = '';
		}
