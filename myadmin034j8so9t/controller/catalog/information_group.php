...
class ControllerCatalogInformationGroup extends Controller { 
	...
	public function index() {
		$this->language->load('catalog/information_group');
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['information_groups'][] = array(
				...
				'code'               => $result['information_group_code'],
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['information_group_code'])) {
			$this->data['information_group_code'] = $this->request->post['information_group_code'];
		} elseif (!empty($information_group_info)) {
			$this->data['information_group_code'] = $information_group_info['information_group_code'];
		} else {
			$this->data['information_group_code'] = '';
		}
