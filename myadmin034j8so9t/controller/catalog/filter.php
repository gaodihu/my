...
class ControllerCatalogFilter extends Controller {
	...
	protected function getForm() {
		...
		$catTree = $this->model_catalog_category->getCatTreeJson('false',false);
		$this->data['catTree']=$catTree;
		//得到当前fiter的所属的所有分类
		//$filter_categories = $this->model_catalog_category->getFilterCategory('false');

		//得到所有属性
		$this->load->model('catalog/attribute');
		$this->data['all_attribute'] = $this->model_catalog_attribute->getAttributes();
