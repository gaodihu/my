...
class ControllerCommonHeader extends Controller {
    protected function index() {
        ...
        if (!$this->user->isLogged()) {
            ...
            $this->data['option_attribute_group'] = $this->url->link('catalog/option_attribute_group', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['customer_points'] = $this->url->link('sale/customer_point', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['report_sale_order_data'] = $this->url->link('report/sale_order_data', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['report_product_sale_data'] = $this->url->link('report/product_sale_data', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['brochures'] = $this->url->link('catalog/brochures', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['review'] = $this->url->link('catalog/review', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['faqs'] = $this->url->link('catalog/faqs', 'token=' . $this->session->data['token'], 'SSL');
            ...
            //export and import
            $this->data['imports_product'][] = array('url'=>$this->url->link('batch/product_import', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品批量上传");
            $this->data['imports_product'][] = array('url'=>$this->url->link('batch/product_update', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品批量修改");
            $this->data['imports_product'][] = array('url'=>$this->url->link('batch/product_update_translate', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品批量翻译");
            $this->data['imports_product'][] = array('url'=>$this->url->link('batch/product_desc_batch', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品描述板块批量修改");
            $this->data['imports_product'][] = array('url'=>$this->url->link('batch/product_desc_update', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品描述板块批量翻译");
            $this->data['imports_attrbute'][] = array('url'=>$this->url->link('batch/attrbute_import', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"编辑新属性值");
            $this->data['imports_attrbute'][] = array('url'=>$this->url->link('batch/product_attrbute_import', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品属性批量上传");
            $this->data['imports'][] =  array('url'=>$this->url->link('batch/shipping_matrixrates', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"批量增加运费数据");
            $this->data['imports'][] = array('url'=>$this->url->link('batch/home_import', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"批量上传首页商品");
            $this->data['imports'][] = array('url'=>$this->url->link('batch/deals_import', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"批量上传特价商品");
            $this->data['imports'][] = array('url'=>$this->url->link('batch/banner_import', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"批量上传网站banner");
            $this->data['imports'][] = array('url'=>$this->url->link('batch/product_hot', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"网站product hot标签");

            //附加功能 addtions
            $this->data['promotions'][] = array('url'=>$this->url->link('additional/get_other_product', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"得到新品");
            $this->data['promotions'][] = array('url'=>$this->url->link('additional/exclusive', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"专属渠道");
            $this->data['promotions'][] = array('url'=>$this->url->link('additional/exclusive_price', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"专属渠道商品");
            $this->data['promotions'][] = array('url'=>$this->url->link('additional/forum', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"论坛引流模块");
            $this->data['suppliers'][] = array('url'=>$this->url->link('additional/get_order_excel', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"下载订单表格");

            //网站节日活动模块
            $this->data['lottery_set'] =$this->url->link('festival/lottery', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['lottery'][] = array('url'=>$this->url->link('festival/easter', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"得奖详情");
            $this->data['sku_action_set'] = array('url'=>$this->url->link('festival/sku_action_set', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品页面活动提示信息设置");
            //日常数据导入导出
            $this->data['lily_data_export'][] =array('url'=>$this->url->link('data/pro_attr_del', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"删除商品属性");
            $this->data['lily_data_export'][] =array('url'=>$this->url->link('data/pro_desc_del', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"删除商品描述信息");
            $this->data['lily_data_export'][] =array('url'=>$this->url->link('data/guiji_del', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"删除商品归集");
            $this->data['lily_data_export'][] =array('url'=>$this->url->link('data/guiji_add', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"增加商品归集");
            $this->data['lily_data_export'][] =array('url'=>$this->url->link('data/export_goods_info', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"导出商品信息");
            $this->data['lily_data_export'][] =array('url'=>$this->url->link('data/pro_img_update', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"商品图片批量处理");
            $this->data['cherrie_data_export'][] =array('url'=>$this->url->link('data/update_clearance', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"更换clearance商品");
            $this->data['cherrie_data_export'][] =array('url'=>$this->url->link('data/del_banner', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"批量删除banner信息");
            $this->data['sale_data_export'][] =array('url'=>$this->url->link('data/export_sku_qty', 'token=' . $this->session->data['token'], 'SSL'),'name'=>"导出sku销售数量信息");
