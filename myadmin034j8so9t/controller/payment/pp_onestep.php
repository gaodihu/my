...
class ControllerPaymentPPOnestep extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			unset($this->request->post['pp_onestep_module']);

			$this->model_setting_setting->editSetting('pp_onestep', $this->request->post);
		...
		$this->data['text_ipn_url'] = HTTPS_CATALOG.'index.php?route=payment/pp_onestep/ipn';
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('payment/pp_onestep', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);

		//button actions
		$this->data['action'] = $this->url->link('payment/pp_onestep', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->post['pp_onestep_username'])) {
			$this->data['pp_onestep_username'] = $this->request->post['pp_onestep_username'];
		} else {
			$this->data['pp_onestep_username'] = $this->config->get('pp_onestep_username');
		}

		if (isset($this->request->post['pp_onestep_password'])) {
			$this->data['pp_onestep_password'] = $this->request->post['pp_onestep_password'];
		} else {
			$this->data['pp_onestep_password'] = $this->config->get('pp_onestep_password');
		}

		if (isset($this->request->post['pp_onestep_signature'])) {
			$this->data['pp_onestep_signature'] = $this->request->post['pp_onestep_signature'];
		} else {
			$this->data['pp_onestep_signature'] = $this->config->get('pp_onestep_signature');
		}
		if (isset($this->request->post['pp_onestep_test'])) {
			$this->data['pp_onestep_test'] = $this->request->post['pp_onestep_test'];
		} else {
			$this->data['pp_onestep_test'] = $this->config->get('pp_onestep_test');
		}

		if (isset($this->request->post['pp_onestep_method'])) {
			$this->data['pp_onestep_method'] = $this->request->post['pp_onestep_method'];
		} else {
			$this->data['pp_onestep_method'] = $this->config->get('pp_onestep_method');
		}

		if (isset($this->request->post['pp_onestep_total'])) {
			$this->data['pp_onestep_total'] = $this->request->post['pp_onestep_total'];
		} else {
			$this->data['pp_onestep_total'] = $this->config->get('pp_onestep_total');
		}

		if (isset($this->request->post['pp_onestep_debug'])) {
			$this->data['pp_onestep_debug'] = $this->request->post['pp_onestep_debug'];
		} else {
			$this->data['pp_onestep_debug'] = $this->config->get('pp_onestep_debug');
		}

		if (isset($this->request->post['pp_onestep_currency'])) {
			$this->data['pp_onestep_currency'] = $this->request->post['pp_onestep_currency'];
		} else {
			$this->data['pp_onestep_currency'] = $this->config->get('pp_onestep_currency');
		}

		$this->data['currency_codes'] = $this->model_payment_pp_onestep->currencyCodes();

		$this->load->model('localisation/order_status');

		$this->data['order_statuses'] = $this->model_localisation_order_status->getOrderStatuses();

		if (isset($this->request->post['pp_onestep_canceled_reversal_status_id'])) {
			$this->data['pp_onestep_canceled_reversal_status_id'] = $this->request->post['pp_onestep_canceled_reversal_status_id'];
		} else {
			$this->data['pp_onestep_canceled_reversal_status_id'] = $this->config->get('pp_onestep_canceled_reversal_status_id');
		}

		if (isset($this->request->post['pp_onestep_completed_status_id'])) {
			$this->data['pp_onestep_completed_status_id'] = $this->request->post['pp_onestep_completed_status_id'];
		} else {
			$this->data['pp_onestep_completed_status_id'] = $this->config->get('pp_onestep_completed_status_id');
		}

		if (isset($this->request->post['pp_onestep_denied_status_id'])) {
			$this->data['pp_onestep_denied_status_id'] = $this->request->post['pp_onestep_denied_status_id'];
		} else {
			$this->data['pp_onestep_denied_status_id'] = $this->config->get('pp_onestep_denied_status_id');
		}

		if (isset($this->request->post['pp_onestep_expired_status_id'])) {
			$this->data['pp_onestep_expired_status_id'] = $this->request->post['pp_onestep_expired_status_id'];
		} else {
			$this->data['pp_onestep_expired_status_id'] = $this->config->get('pp_onestep_expired_status_id');
		}

		if (isset($this->request->post['pp_onestep_failed_status_id'])) {
			$this->data['pp_onestep_failed_status_id'] = $this->request->post['pp_onestep_failed_status_id'];
		} else {
			$this->data['pp_onestep_failed_status_id'] = $this->config->get('pp_onestep_failed_status_id');
		}

		if (isset($this->request->post['pp_onestep_pending_status_id'])) {
			$this->data['pp_onestep_pending_status_id'] = $this->request->post['pp_onestep_pending_status_id'];
		} else {
			$this->data['pp_onestep_pending_status_id'] = $this->config->get('pp_onestep_pending_status_id');
		}

		if (isset($this->request->post['pp_onestep_processed_status_id'])) {
			$this->data['pp_onestep_processed_status_id'] = $this->request->post['pp_onestep_processed_status_id'];
		} else {
			$this->data['pp_onestep_processed_status_id'] = $this->config->get('pp_onestep_processed_status_id');
		}

		if (isset($this->request->post['pp_onestep_refunded_status_id'])) {
			$this->data['pp_onestep_refunded_status_id'] = $this->request->post['pp_onestep_refunded_status_id'];
		} else {
			$this->data['pp_onestep_refunded_status_id'] = $this->config->get('pp_onestep_refunded_status_id');
		}

		if (isset($this->request->post['pp_onestep_reversed_status_id'])) {
			$this->data['pp_onestep_reversed_status_id'] = $this->request->post['pp_onestep_reversed_status_id'];
		} else {
			$this->data['pp_onestep_reversed_status_id'] = $this->config->get('pp_onestep_reversed_status_id');
		}

		if (isset($this->request->post['pp_onestep_voided_status_id'])) {
			$this->data['pp_onestep_voided_status_id'] = $this->request->post['pp_onestep_voided_status_id'];
		} else {
			$this->data['pp_onestep_voided_status_id'] = $this->config->get('pp_onestep_voided_status_id');
		}

		if (isset($this->request->post['pp_onestep_allow_note'])) {
			$this->data['pp_onestep_allow_note'] = $this->request->post['pp_onestep_allow_note'];
		} else {
			$this->data['pp_onestep_allow_note'] = $this->config->get('pp_onestep_allow_note');
		}

		if (isset($this->request->post['pp_onestep_logo'])) {
			$this->data['pp_onestep_logo'] = $this->request->post['pp_onestep_logo'];
		} else {
			$this->data['pp_onestep_logo'] = $this->config->get('pp_onestep_logo');
		}

		if (isset($this->request->post['pp_onestep_border_colour'])) {
			$this->data['pp_onestep_border_colour'] = str_replace('#', '', $this->request->post['pp_onestep_border_colour'] );
		} else {
			$this->data['pp_onestep_border_colour'] = $this->config->get('pp_onestep_border_colour');
		}

		if (isset($this->request->post['pp_onestep_header_colour'])) {
			$this->data['pp_onestep_header_colour'] = str_replace('#', '', $this->request->post['pp_onestep_header_colour'] );
		} else {
			$this->data['pp_onestep_header_colour'] = $this->config->get('pp_onestep_header_colour');
		}

		if (isset($this->request->post['pp_onestep_page_colour'])) {
			$this->data['pp_onestep_page_colour'] = str_replace('#', '', $this->request->post['pp_onestep_page_colour'] );
		} else {
			$this->data['pp_onestep_page_colour'] = $this->config->get('pp_onestep_page_colour');
		}

		if (isset($this->request->post['pp_onestep_profile_cancel_status'])) {
			$this->data['pp_onestep_profile_cancel_status'] = $this->request->post['pp_onestep_profile_cancel_status'];
		} else {
			$this->data['pp_onestep_profile_cancel_status'] = $this->config->get('pp_onestep_profile_cancel_status');
		}

		$this->load->model('tool/image');

		$logo = $this->config->get('pp_onestep_logo');

		if (isset($this->request->post['pp_onestep_logo']) && file_exists(DIR_IMAGE . $this->request->post['pp_onestep_logo'])) {
			$this->data['thumb'] = $this->model_tool_image->resize($this->request->post['pp_onestep_logo'], 750, 90);
		...
		if (isset($this->request->post['pp_onestep_geo_zone_id'])) {
			$this->data['pp_onestep_geo_zone_id'] = $this->request->post['pp_onestep_geo_zone_id'];
		} else {
			$this->data['pp_onestep_geo_zone_id'] = $this->config->get('pp_onestep_geo_zone_id');
		}
		...
		if (isset($this->request->post['pp_onestep_status'])) {
			$this->data['pp_onestep_status'] = $this->request->post['pp_onestep_status'];
		} else {
			$this->data['pp_onestep_status'] = $this->config->get('pp_onestep_status');
		}

		if (isset($this->request->post['pp_onestep_sort_order'])) {
			$this->data['pp_onestep_sort_order'] = $this->request->post['pp_onestep_sort_order'];
		} else {
			$this->data['pp_onestep_sort_order'] = $this->config->get('pp_onestep_sort_order');
		}

		$this->data['token'] = $this->session->data['token'];

		$this->template = 'payment/pp_onestep.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);		
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'payment/pp_onestep')) {
			$this->error['warning'] = $this->language->get('error_permission');
		}

		if (empty($this->request->post['pp_onestep_username'])) {
			$this->error['username'] = $this->language->get('error_username');
		}

		if (empty($this->request->post['pp_onestep_password'])) {
			$this->error['password'] = $this->language->get('error_password');
		}

		if (empty($this->request->post['pp_onestep_signature'])) {
	...
	public function resend() {
			...
			if (isset($this->request->get['paypal_order_transaction_id'])) {
				$transaction = $this->model_payment_pp_onestep->getFailedTransaction($this->request->get['paypal_order_transaction_id']);

				if ($transaction) {
					$call_data = unserialize($transaction['call_data']);

					$result = $this->model_payment_pp_onestep->call($call_data);

					if ($result) {

						$parent_transaction = $this->model_payment_pp_onestep->getLocalTransaction($transaction['parent_transaction_id']);
						...
						$this->model_payment_pp_onestep->updateTransaction($transaction);
	...
	public function capture() {
		...
		if(isset($this->request->post['order_id']) && $this->request->post['amount'] > 0 && isset($this->request->post['order_id']) && isset($this->request->post['complete'])) {
			...
			$paypal_order = $this->model_payment_pp_onestep->getOrder($this->request->post['order_id']);
			...
			if ($result == false) {
				...
				$paypal_order_transaction_id = $this->model_payment_pp_onestep->addTransaction($transaction, $call_data);
				...
				$captured = number_format($this->model_payment_pp_onestep->totalCaptured($paypal_order['paypal_order_id']), 2);
				$refunded = number_format($this->model_payment_pp_onestep->totalRefundedOrder($paypal_order['paypal_order_id']), 2);
				...
				if($transaction['remaining'] == 0.00) {
					...
					$this->model_payment_pp_onestep->updateOrder('Complete', $this->request->post['order_id']);
				}
				...
				if($this->request->post['complete'] == 1 && $transaction['remaining'] > 0) {
					...
					$this->model_payment_pp_onestep->addTransaction($transaction['void']);
					$this->model_payment_pp_onestep->updateOrder('Complete', $this->request->post['order_id']);
	...
	public function refund() {
		...
		$this->load->language('payment/pp_onestep_refund');
		...
		$this->data['breadcrumbs'][] = array(
			'text'      => $this->language->get('text_pp_onestep'),
			'href'      => $this->url->link('payment/pp_onestep', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('payment/pp_onestep/refund', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);

		//button actions
		$this->data['action'] = $this->url->link('payment/pp_onestep/doRefund', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['cancel'] = $this->url->link('payment/pp_onestep', 'token=' . $this->session->data['token'], 'SSL');

		$this->data['transaction_id'] = $this->request->get['transaction_id'];

		$this->load->model('payment/pp_onestep');
		$pp_transaction = $this->model_payment_pp_onestep->getTransaction($this->request->get['transaction_id']);

		$this->data['amount_original'] = $pp_transaction['AMT'];
		$this->data['currency_code'] = $pp_transaction['CURRENCYCODE'];

		$refunded = number_format($this->model_payment_pp_onestep->totalRefundedTransaction($this->request->get['transaction_id']), 2);
		...
		$this->template = 'payment/pp_onestep_refund.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function doRefund() {
		...
		if(isset($this->request->post['transaction_id']) && isset($this->request->post['refund_full'])) {
			...
			if($this->request->post['refund_full'] == 0 && $this->request->post['amount'] == 0) {
				...
				$order_id = $this->model_payment_pp_onestep->getOrderId($this->request->post['transaction_id']);
				$paypal_order = $this->model_payment_pp_onestep->getOrder($order_id);
				...
				if ($paypal_order) {
					...
					$current_transaction = $this->model_payment_pp_onestep->getLocalTransaction($this->request->post['transaction_id']);
					...
					if ($result == false) {
						...
						$this->model_payment_pp_onestep->addTransaction($transaction, $call_data);
						...
						$this->model_payment_pp_onestep->log(json_encode($result));
						...
						$this->redirect($this->url->link('payment/pp_onestep/refund', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->post['transaction_id'], 'SSL'));
					}
				} else {
	...
	public function install() {
		$this->load->model('payment/pp_onestep');
		$this->model_payment_pp_onestep->install();
	}

	public function uninstall() {
		$this->load->model('payment/pp_onestep');
		$this->model_payment_pp_onestep->uninstall();
	}

	public function orderAction() {
		if ($this->config->get('pp_onestep_status')) {
			$this->load->model('payment/pp_onestep');
			$this->load->language('payment/pp_onestep_order');

			$paypal_order = $this->model_payment_pp_onestep->getOrder($this->request->get['order_id']);
			...
			if ($paypal_order) {
				...
				$captured = number_format($this->model_payment_pp_onestep->totalCaptured($this->data['paypal_order']['paypal_order_id']), 2);
				$refunded = number_format($this->model_payment_pp_onestep->totalRefundedOrder($this->data['paypal_order']['paypal_order_id']), 2);
				...
				$this->data['refund_link'] = $this->url->link('payment/pp_onestep/refund', 'token=' . $this->session->data['token'], 'SSL');
				$this->data['view_link'] = $this->url->link('payment/pp_onestep/viewTransaction', 'token=' . $this->session->data['token'], 'SSL');
				$this->data['resend_link'] = $this->url->link('payment/pp_onestep/resend', 'token=' . $this->session->data['token'], 'SSL');

				$this->template = 'payment/pp_onestep_order.tpl';
				$this->response->setOutput($this->render());
			}
		}
	}
	...
	public function search() {
		...
		$this->load->language('payment/pp_onestep_search');
		$this->load->model('payment/pp_onestep');
		...
		$this->data['currency_codes'] = $this->model_payment_pp_onestep->currencyCodes();
		$this->data['default_currency'] = $this->config->get('pp_onestep_currency');
		...
		$this->data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('payment/pp_onestep/search', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->template = 'payment/pp_onestep_search.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function viewTransaction() {
		$this->load->model('payment/pp_onestep');
		$this->load->language('payment/pp_onestep_view');

		$this->data['transaction'] = $this->model_payment_pp_onestep->getTransaction($this->request->get['transaction_id']);
		...
		$this->data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('payment/pp_onestep/viewTransaction', 'token=' . $this->session->data['token'] . '&transaction_id=' . $this->request->get['transaction_id'], 'SSL'),
			'separator' => ' :: '
		);

		$this->template = 'payment/pp_onestep_view.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function recurringCancel() {
		...
		if($profile && !empty($profile['profile_reference'])) {
			...
			$result = $this->model_payment_pp_onestep->recurringCancel($profile['profile_reference']);
