...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['point_reward'])) {
			$this->data['error_point_reward'] = $this->error['point_reward'];
		} else {
			$this->data['error_point_reward'] = '';
		}
       ...
       if (isset($this->request->post['config_meta_keywords'])) {
        ...
        if (isset($this->request->post['config_point_reward'])) {
			$this->data['config_point_reward'] = $this->request->post['config_point_reward'];
		} else {
			$this->data['config_point_reward'] = $this->config->get('config_point_reward');
		}	
	...
	protected function validate() {
		...
		if (!$this->request->post['config_point_reward']) {
			$this->error['point_reward'] = $this->language->get('error_point_reward');
		}
