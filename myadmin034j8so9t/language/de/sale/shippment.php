<?php
// Heading
$_['heading_title']                           = 'New Shippment';

// Text
$_['heading']                           = 'New Shippment For #.%s';
$_['text_amazon_order_id']                    = 'Amazon Order ID:';
$_['text_name']                               = 'Name:';
$_['text_success']                            = 'Success: You have modified orders!';
$_['text_order_id']                           = 'Order ID:';
$_['text_invoice_no']                         = 'Shippment No.:';
$_['text_invoice_date']                       = 'Shippment Date:';
...
$_['main_order_tips'] = '<br/>Your order# %s under order# %s has been shipped out on %s.<br/>';
