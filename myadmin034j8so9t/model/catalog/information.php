...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET information_group_id='".(int)$data['information_group_id']."',sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "'");
	...
	public function editInformation($information_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "information SET information_group_id='".(int)$data['information_group_id']."',sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', status = '" . (int)$data['status'] . "' WHERE information_id = '" . (int)$information_id . "'");
	...
	public function getInformations($data = array()) {
		if ($data) {
			...
			$sort_data = array(
                'i.information_id',
                'i.information_group_id',
				'id.title',
				'i.sort_order'
			);		
           if (isset($data['filter_id'])) {
				$sql .= " and  i.information_id=" . $data['filter_id'];	
		    }
            if (isset($data['filter_name'])) {
				$sql .= " and  id.title like '%" . $data['filter_name']."%' ";	
		    } 
            if (isset($data['filter_information_group'])) {
				$sql .= " and  i.information_group_id=" . $data['filter_information_group'];	
		    } 
