...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-category">category</a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-profile"><?php echo $tab_profile; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <tr>
                <td>Mate Title</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][title]" cols="40" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['title'] : ''; ?></textarea></td>
              </tr>
              <tr>
			  ...
			  <tr>
                <td>Shipping & Payments</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][shipping_description]" id="shipping_description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['shipping_description']) ? $product_description[$language['language_id']]['shipping_description'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Packaging List</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][packaging_list]" id="packaging_list<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['packaging_list']) ? $product_description[$language['language_id']]['packaging_list'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Read More</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][read_more]" id="read_more<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['read_more']) ? $product_description[$language['language_id']]['read_more'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Application Image</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][application_image]" id="application_image<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['application_image']) ? $product_description[$language['language_id']]['application_image'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Size Image</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][size_image]" id="size_image<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['size_image']) ? $product_description[$language['language_id']]['size_image'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Features</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][features]" id="features<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['features']) ? $product_description[$language['language_id']]['features'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Installation Method/Usage</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][installation_method]" id="installation_method<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['installation_method']) ? $product_description[$language['language_id']]['installation_method'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Video</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][video]" id="video<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['video']) ? $product_description[$language['language_id']]['video'] : ''; ?></textarea></td>
              </tr>
			  <tr>
                <td>Notes</td>
                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][notes]" id="notes<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]['notes']) ? $product_description[$language['language_id']]['notes'] : ''; ?></textarea></td>
              </tr>
              <tr>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <tr>
                  <td><span class="required">*</span>url path</td>
                  <td><input type="text" name="url_path" value="<?php echo $url_path; ?>" size="100" />
                      <?php if ($error_url_path) { ?>
                      <span class="error"><?php echo $error_url_path; ?></span>
                      <?php } ?></td>
              </tr>
			...
			<tr>
              ...
              <td>
			  <?php if($is_new){ ?>
			  <input type="radio" checked="checked" value="1" name="is_new">YES
			  <input type="radio"  value="0" name="is_new">NO
			  <?php } else{ ?>
			  <input type="radio"  value="1" name="is_new">YES
			  <input type="radio" checked="checked" value="0" name="is_new">NO
			  <?php } ?>
			   </td>
            </tr>
			<tr>
              <td>is hot</td>
              <td><?php if($is_hot){ ?>
			  <input type="radio" checked="checked" value="1" name="is_hot">YES
			  <input type="radio"  value="0" name="is_hot">NO
			  <?php } else{ ?>
			  <input type="radio" value="1" name="is_hot">YES
			  <input type="radio" checked="checked" value="0" name="is_hot">NO
			  <?php } ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Supplier code</td>
              <td><input type="text" name="supplier_code" value="<?php echo $supplier_code; ?>" /></td>
            </tr>
            <tr>
           ...
           <tr>
              ...
              <td><select name="battery_type">
                  <option value="0"  <?php if ($battery_type == 0) { ?>selected="selected"<?php } ?>>不含电池</option>
                  <option value="1"  <?php if ($battery_type == 1) { ?>selected="selected"<?php } ?>>纽扣电池</option>
                  <option value="2"  <?php if ($battery_type == 2) { ?>selected="selected"<?php } ?>>内置电池</option>
                  <option value="3"  <?php if ($battery_type == 3) { ?>selected="selected"<?php } ?>>配置电池</option>
                  <option value="4"  <?php if ($battery_type == 4) { ?>selected="selected"<?php } ?>>纯电池</option>
                </select></td>
            </tr>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="related" value="" />
          ...
          <table id="attribute" class="list">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left" id='pro_attr_option'>
				<?php if($value['option']){
				?>
					<table>
						<tr>
				<?php
						foreach($value['option'] as $option_value){
							if(in_array($option_value['option_id'],$pro_option_array)){
				?>
				<td class='left'><input type="checkbox" value="<?php echo $option_value['option_id'];?>" name ="attr_option[]" checked='checked'><?php echo $option_value['option_value'];?>
				</td>
				<?php
					}
					else{
				?>
				<td class='left'><input type="checkbox" value="<?php echo $option_value['option_id'];?>" name ="attr_option[]"><?php echo $option_value['option_value'];?>
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                <td class="left"><select name="product_discount[<?php echo $discount_row; ?>][customer_group_id]">
					<?php if($product_discount['customer_group_id']==0){ ?>
        ...
        <div id="tab-special">
          <table class="list">
            <tr><td>Max sales Number:</td><td><input type='text' name='deals_limit_number' value="<?php echo $deals_limit_number;?>">（留空或为0则表示该商品不进行限时抢购）</td></tr>
          </table>
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                <td class="left"><select name="product_special[<?php echo $special_row; ?>][customer_group_id]">
					<?php if($product_special['customer_group_id']==0){ ?>
					<option value="0" selected="selected">All Groups</option>
					<?php }else{ ?>
					<option value="0" >All Groups</option>
					<?php } ?>
...
<?php $ckedit_array =array('description','shipping_description','packaging_list','read_more','application_image','size_image','features','installation_method','video','notes'); ?>
<?php foreach ($languages as $language) { ?>
<?php foreach($ckedit_array  as $value){ ?>
CKEDITOR.replace('<?php echo $value.$language['language_id']; ?>', {
...
function addAttribute() {
	...
	<?php foreach($all_attributes as $value){
	?>
	html +=	'<option value="<?php echo $value['attribute_id'];?>"><?php echo $value['name'];?> </option>';
	<?php
	}?>
	html +=	'</select>';
	html += '    <td class="left">';
...
function addDiscount() {
	...
	$('#discount-row' + discount_row + ' .datetime').datetimepicker({
		dateFormat: 'yy-mm-dd',
		timeFormat: 'hh:mm:ss',
		changeMonth: true,
		changeYear: true
...
function addSpecial() {
	...
	html += '      <option value="0">All groups</option>';
    <?php foreach ($customer_groups as $customer_group) { ?>
    html += '      <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo addslashes($customer_group['name']); ?></option>';
    <?php } ?>
    html += '    </select></td>';		
	...
	$('#special-row' + special_row + ' .datetime').datetimepicker({
		dateFormat: 'yy-mm-dd',
		timeFormat: 'hh:mm:ss',
		changeMonth: true,
		changeYear: true
...
<script type="text/javascript">
	...
	zNodes = znodeArr;
		...
		$(document).ready(function(){
			...
			//设置默认选中的树
			<?php  foreach($product_categories as $key => $pro_cat){

			?>
				//treeObj.getNodeByParam("id", <?php echo $pro_cat['category_id'];?>, null);
				treeObj.selectNode(treeObj.getNodeByParam("id", <?php echo $pro_cat['category_id'];?>, null),true,true);
				treeObj.checkNode(treeObj.getNodeByParam("id", <?php echo $pro_cat['category_id'];?>, null), true, true);
			<?php 
			}
			?>
	...
	function onCheck(e,treeId,treeNode){
		...
		if(treeNode.checked==true){
			var content ="<input type='hidden' value='"+treeNode.id+"' name='product_category[]'>";
			$('.zTreeDemoBackground').after(content);
		}
		else if(treeNode.checked==false){
			var obj =$("input[name='product_category[]'][value='"+treeNode.id+"']");
		    obj.remove();
		}
