        ...
        <div id="tab-data">
          <table class="form">
			...
			<tr>
              <td>文章分类</td>
              <td>
			  	<select name="information_group_id">
					<option value="-1">请选择</option>
					<?php if(isset($information_groups)){
						foreach($information_groups as $information_group){ 
					?>
					<?php if($information_group['information_group_id']==$information_group_id){ ?>
					<option value="<?php echo $information_group['information_group_id'];?>" selected="selected"><?php echo $information_group['information_group_code'];?></option>
					<?php }else{ ?>
					<option value="<?php echo $information_group['information_group_id'];?>"><?php echo $information_group['information_group_code'];?></option>
					<?php } ?>
