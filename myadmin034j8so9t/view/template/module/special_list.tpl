        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td class="left"><?php echo $banner['banner_code']; ?></td>
			  <td class="left"><?php echo $banner['banner_width']; ?></td>
			  <td class="left"><?php echo $banner['banner_height']; ?></td>
