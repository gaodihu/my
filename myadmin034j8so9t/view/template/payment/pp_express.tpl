                ...
                <div id="tab-api-details">
                    <table class="form">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td><span class="required"></span>是否开启小额账号</td>
                            <td>
                                <select name='pp_express_small_enabled'>
                                    <option value='1' <?php if($pp_express_small_enabled == 1) { ?>selected<?php } ?>>开启</option>
                                    <option value='0' <?php if($pp_express_small_enabled == 0) { ?>selected<?php } ?>>关闭</option>
                                </select>
                           </td>
                         </tr>
                     ...
                     <tr>
                         <td><span class="required"></span>小额账号最高限制(美元)</td>
                          <td><input type="text" name="pp_express_small_limit" value="<?php echo $pp_express_small_limit; ?>"/>
                                <?php if (isset($error['small_limit'])) { ?>
                                    <span class="error"><?php echo $error['small_limit']; ?></span>
                                <?php } ?>
                          </td>
                      </tr>
                        ...
                        <tr>
                            <td><span class="required"></span>小额账号 <?php echo $entry_username; ?></td>
                            <td><input type="text" name="pp_express_username_small" value="<?php echo $pp_express_username_small; ?>"/>
                                <?php if (isset($error['username_small'])) { ?>
                                    <span class="error"><?php echo $error['username_small']; ?></span>
                                <?php } ?>
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required"></span> 小额账号 <?php echo $entry_password; ?></td>
                            <td><input type="text" name="pp_express_password_small" value="<?php echo $pp_express_password_small; ?>"/>
                                <?php if (isset($error['password_small'])) { ?>
                                    <span class="error"><?php echo $error['password_small']; ?></span>
                                <?php } ?>
                            </td>
                        </tr>
                        <tr>
                            <td><span class="required"></span>小额账号 <?php echo $entry_signature; ?></td>
                            <td><input type="text" name="pp_express_signature_small" value="<?php echo $pp_express_signature_small; ?>"/>
                                <?php if (isset($error['signature_small'])) { ?>
                                <span class="error"><?php echo $error['signature_small']; ?></span>
                                <?php } ?>
                            </td>
                        </tr>
