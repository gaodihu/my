      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td>
                <select name='pp_small_standard_enabled'>
                    <option value='1' <?php if($pp_small_standard_enabled == 1) { ?>selected<?php } ?>>开启</option>
                    <option value='0' <?php if($pp_small_standard_enabled == 0) { ?>selected<?php } ?>>关闭</option>
                </select>
           </td>
         </tr>
         ...
         <tr>
            <td><span class="required"></span>小额账号最高金额(美金)</td>
            <td><input type="text" name="pp_small_standard_limit" value="<?php echo $pp_small_standard_limit; ?>" />
              <?php if ($error_small_limit) { ?>
              <span class="error"><?php echo $error_small_limit; ?></span>
              <?php } ?></td>
         </tr>
         
         <tr>
            <td><span class="required"></span>小额账号</td>
            <td><input type="text" name="pp_small_standard_email" value="<?php echo $pp_small_standard_email; ?>" />
              <?php if ($error_small_email) { ?>
              <span class="error"><?php echo $error_small_email; ?></span>
              <?php } ?></td>
         </tr>
