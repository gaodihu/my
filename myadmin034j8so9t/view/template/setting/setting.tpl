    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-option">
          ...
          <table class="form">
            <tr>
              <td><span class="required">*</span> 积分兑换(1美元可兑换的积分)</td>
              <td><input type="text" name="config_point_reward" value="<?php echo $config_point_reward; ?>" size="3" />
                <?php if ($error_point_reward) { ?>
                <span class="error"><?php echo $error_point_reward; ?></span>
                <?php } ?></td>
            </tr>
          </table>
