...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
	  <a class="button" onclick="queding('<?php echo $reset_password;?>')">重置密码</a>
    ...
    <div class="content">
	  ...
	  <a href="#tab-ship-address">Shiping Address</a>
      <a href="#tab-billing-address">Billing Address</a>    
        <?php if ($customer_id) { ?>
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                ...
                <td><select name="address[<?php echo $address_row; ?>][country_id]" onchange="country(this, '<?php echo $address_row; ?>', '<?php echo $address['zone_id']; ?>','<?php echo $address['zone']; ?>');">
              ...
              <tr>
                ...
                <td>
                    <?php if($address['zone_id']){ ?>
                    <select name="address[<?php echo $address_row; ?>][zone_id]">
                  </select>
                    <?php } ?>

                  <span id="address_zone_<?php echo $address_row;?>"  <?php if($address['zone_id']){ ?> style="display: none" <?php } ?>><input type="text" value="<?php echo $address['zone'];?>" name="address[<?php echo $address_row; ?>][zone]"></span>
              ...
              <tr>
                ...
                <?php } ?>
				<input type="hidden" name="address[<?php echo $address_row; ?>][type]" value="shipping" />
              </tr>
            </table>
          </div>
          <?php $address_row++; ?>
	  ...
	  <div id="tab-billing-address">
            <table class="form">
			<input type="hidden" name="address[<?php echo $address_row; ?>][address_id]" value="<?php echo $b_address['address_id']; ?>" />
              <tr>
                <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][firstname]" value="<?php echo $b_address['firstname']; ?>" />
                  <?php if (isset($error_address_firstname[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_firstname[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][lastname]" value="<?php echo $b_address['lastname']; ?>" />
                  <?php if (isset($error_address_lastname[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_lastname[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><?php echo $entry_company; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][company]" value="<?php echo $b_address['company']; ?>" /></td>
              </tr>
              <tr class="company-id-display">
                <td><?php echo $entry_company_id; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][company_id]" value="<?php echo $b_address['company_id']; ?>" /></td>
              </tr>
              <tr class="tax-id-display">
                <td><?php echo $entry_tax_id; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][tax_id]" value="<?php echo $b_address['tax_id']; ?>" />
                  <?php if (isset($error_address_tax_id[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_tax_id[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_address_1; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_1]" value="<?php echo $b_address['address_1']; ?>" />
                  <?php if (isset($error_address_address_1[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_address_1[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><?php echo $entry_address_2; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_2]" value="<?php echo $b_address['address_2']; ?>" /></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_city; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][city]" value="<?php echo $b_address['city']; ?>" />
                  <?php if (isset($error_address_city[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_city[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><span id="postcode-required<?php echo $address_row; ?>" class="required">*</span> <?php echo $entry_postcode; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][postcode]" value="<?php echo $b_address['postcode']; ?>" /></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_country; ?></td>
                <td><select name="address[<?php echo $address_row; ?>][country_id]" onchange="country(this, '<?php echo $address_row; ?>', '<?php echo $b_address['zone_id']; ?>','<?php echo $b_address['zone']; ?>');">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php foreach ($countries as $country) { ?>
                    <?php if ($country['country_id'] == $b_address['country_id']) { ?>
                    <option value="<?php echo $country['country_id']; ?>" selected="selected"><?php echo $country['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $country['country_id']; ?>"><?php echo $country['name']; ?></option>
                    <?php } ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span id="address_zone_<?php echo $address_row;?>"><input type="text" value="<?php echo $address['zone'];?>" name="address[<?php echo $address_row; ?>][zone]"></span>

                  <?php if (isset($error_address_zone[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_zone[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
			  <input type="hidden" name="address[<?php echo $address_row; ?>][type]" value="billing" />
            </table>
          </div>
	  <?php $address_row++; ?>
      </form>
        ...
        <div id="tab-reward">
		 <form action="" method="post">
          <table class="form">
            ...
            <tr>
              <td>Points</td>
              <td><input type="text" name="points" value="" />(不送填写0)</td>
            </tr>
            <tr>
...
//--></script> 
<script type="text/javascript"><!--
function country(element, index, zone_id,zone) {
  if (element.value != '') {
		$.ajax({
			...
			success: function(json) {
				...
				if (json['zone'] != '') {
					$('select[name=\'address[' + index + '][zone_id]\']').show();
					$('#address_zone_'+index).hide();
                    ...
                    $('select[name=\'address[' + index + '][zone_id]\']').hide();
					var seleted_cid ="<?php echo $b_address['country_id']?$b_address['country_id']:'';?>";

					if($('select[name=\'address[' + index + '][country_id]\']').val()==seleted_cid){
						html = "<input type='text' value='"+zone+"' name='address["+index+"][zone]'>";
					}else{
						html = "<input type='text' value='' name='address["+index+"][zone]'>";
					}
					
                    $('#address_zone_'+index).html(html);
                    $('#address_zone_'+index).show();
				}
...
function addAddress() {	
    ...
    html += '    </tr>';
	html += ' <input type="hidden" value="shipping" name="address[' + address_row + '][type]"';
    html += '  </table>';
    html += '</div>';
	
	$('#tab-ship-address').append(html);
...
function addRewardPoints() {
	$.ajax({
		...
		type: 'post',
		dataType: 'html',
		data: 'order_number=' + encodeURIComponent($('#tab-reward input[name=\'order_number\']').val()) + '&points=' + encodeURIComponent($('#tab-reward input[name=\'points\']').val()),
		beforeSend: function() {
			$('.success, .warning').remove();
...
function queding(location_href){
	console.log(124);
