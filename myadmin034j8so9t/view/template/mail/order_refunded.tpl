  ...
  <tr>
    <td bgcolor="#f1f1f1">
      <table width="700" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="698" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#333; border:1px solid #dcdcdc; padding:15px 20px; line-height:24px; background-color:#fff;"><?php echo $text_main_content;?>
...
<?php echo $order['payment_information'];?></td></tr>
  ...
  <tr>
    <td bgcolor="#f6f6f6" style="line-height:30px;">
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="510" align="right"><?php echo $total['title'];?></td><td width="10"></td><td width="140" style="font-weight:bold;"><?php echo $total['text'];?></td>
        </tr>
      </table>
    </td>
  </tr>
