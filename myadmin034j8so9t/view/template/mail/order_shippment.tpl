  ...
  <tr>
    <td bgcolor="#f1f1f1">
      <table width="700" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="698" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#333; border:1px solid #dcdcdc; padding:15px 20px; line-height:24px; background-color:#fff;"><?php echo $text_main_content;?><?php echo $main_order_tips; ?>
<table width="660" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-size:12px; line-height:18px;">
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="500" valign="top" style="border:1px solid #e5e5e5">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr><td height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_payment_method;?></td></tr>
              <tr><td width="496" valign="top" style="padding:10px;"><?php echo $order['payment_method'];?><br/>
<?php echo $order['payment_information'];?></td></tr>
            </table>
          </td>
        </tr>
      </table>
      ...
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top" style="border:1px solid #e5e5e5">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr><td width="180" height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_shipping_information;?></td></tr>
              <tr><td width="180" valign="top" style="padding:10px;"><?php echo $order['shipping_address'];?></td></tr>
            </table>
          </td>
          <td width="10"></td>
          <td valign="top" style="border:1px solid #e5e5e5">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr><td width="466" height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_shipping_method;?></td></tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="top" style="border-right:1px solid #e5e5e5;">
                        <table border="0" cellpadding="0" cellspacing="0">
                          <tr><td width="233" height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_shipped_by;?></td><td width="233" height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_stracking_number;?></td></tr>
						  <?php foreach($tracks as $track){ ?>
							...
							<tr><td valign="top" style="padding:10px;"><?php echo $text_tarcking;?></td><td valign="top" style="padding:10px;"><a href="<?php echo $track['track_url'];?>" target= '_blank'><?php echo $track['track_url'];?></a></td></tr>
							<?php } ?>
						  <?php } ?>
                        </table>
                      </td>
