    ...
    <td bgcolor="#f1f1f1">
      <table width="700" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		 ...
		 <?php echo $text_main_content_address;?>
<table width="660" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td style="font-size:12px; line-height:18px;">
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="300" valign="top" style="border:1px solid #e5e5e5">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr><td height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_payment_information;?></td></tr>
              <tr><td width="300" valign="top" style="padding:10px;"><?php echo $order['payment_address'];?></td></tr>
            </table>
          </td>
        </tr>
      </table>
      ...
      <table border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top" style="border:1px solid #e5e5e5">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr><td width="300" height="40" bgcolor="#f6f6f6" style="padding:0px 10px; font-weight:bold; font-size:13px; border-bottom:1px solid #e5e5e5;"><?php echo $text_shipping_information;?></td></tr>
              <tr><td width="300" valign="top" style="padding:10px;"><?php echo $order['shipping_address'];?></td></tr>
            </table>
          </td>
          <td width="10"></td>
        </tr>
...
<?php echo $text_main_content_product;?>
<table>
  <tr>
...
<?php echo $text_main_content_2;?>
<?php echo $text_no_reply;?>
</td>
        </tr>
