...
<div id="container">
 ...
 <!--         <li><a href="<?php echo $option; ?>"><?php echo $text_option; ?></a></li>
		  ...
		  <li><a href="<?php echo $brochures; ?>">Brochures & Spec</a></li>-->
          <li><a href="<?php echo $review; ?>"><?php echo $text_review; ?></a></li>
		  <li><a href="<?php echo $faqs; ?>"><?php echo $text_faqs; ?></a></li>
		  <li><a href="<?php echo $information_group; ?>">information group</a></li>
         ...
         <!--  <li><a href="<?php echo $recurring_profile; ?>"><?php echo $text_recurring_profile; ?></a></li>
          ...
          <li><a class="parent"><?php echo $text_customer; ?></a>
            <ul>
			  ...
			  <li><a href="<?php echo $customer_points; ?>">customer points</a></li>
        ...
        <ul>
          <li><a class="parent"><?php echo $text_sale; ?></a>
            <ul>
			  ...
			  <li><a href="<?php echo $report_sale_order_data; ?>">销售统计数据</a></li>
			  <li><a href="<?php echo $report_product_sale_data; ?>">产品销售统计</a></li>
	  ...
	  <li id="help"><a class="top">批量数据处理</a>
        <ul>
		<li><a class="parent">商品批量处理</a>
                <ul>
                   <?php foreach($imports_product as $import) { ?>
						<li><a href="<?php echo $import['url'] ;?>"><?php echo $import['name'] ;?></a></li>
					<?php } ?>
                </ul>
           </li>
		   <li><a class="parent">商品新属性批量处理</a>
                <ul>
                   <?php foreach($imports_attrbute as $import) { ?>
						<li><a href="<?php echo $import['url'] ;?>"><?php echo $import['name'] ;?></a></li>
					<?php } ?>
                </ul>
           </li>
	  ...
	  <li id="help"><a class="top">附加功能</a>
        <ul>
		<li><a class="parent">推广功能</a>
		  	 <ul>
			 	<?php foreach($promotions as $promotion) { ?>
              		<li><a href="<?php echo $promotion['url']; ?>"><?php echo $promotion['name']; ?></a></li>
			 	<?php } ?>
            </ul>
		  </li>
		  <li><a class="parent">采购功能</a>
		  	 <ul>
			 	<?php foreach($suppliers as $supplier) { ?>
              		<li><a href="<?php echo $supplier['url']; ?>"><?php echo $supplier['name']; ?></a></li>
			 	<?php } ?>
            </ul>
		  </li>
	  ...
	  <li id="help"><a class="top">节日活动</a>
		  <ul>
			  <li><a class="parent">抽奖活动</a>
						<ul>
							<li><a href="<?php echo $lottery_set ;?>">设置抽奖活动</a></li>
						   <?php foreach($lottery as $import) { ?>
								<li><a href="<?php echo $import['url'] ;?>"><?php echo $import['name'] ;?></a></li>
							<?php } ?>
						</ul>
			   </li>
			   <li><a href="<?php echo $sku_action_set['url'] ;?>"><?php echo $sku_action_set['name'] ;?></a></li>
			</ul>
      </li>

	  <li id="help"><a class="top">日常数据处理</a>
        <ul>
		<li><a class="parent">产品编辑数据处理</a>
		  	 <ul>
			 	<?php foreach($lily_data_export as $val) { ?>
              		<li><a href="<?php echo $val['url']; ?>"><?php echo $val['name']; ?></a></li>
			 	<?php } ?>
            </ul>
		  </li>
        <li><a class="parent">站内数据处理</a>
           <ul>
               <?php foreach($cherrie_data_export as $val) { ?>
                <li><a href="<?php echo $val['url']; ?>"><?php echo $val['name']; ?></a></li>
               <?php } ?>
            </ul>
        </li>
        <li><a class="parent" >站内销售数据</a>
            <ul>
                <?php foreach($sale_data_export as $val) { ?>
                <li><a href="<?php echo $val['url']; ?>"><?php echo $val['name']; ?></a></li>
                <?php } ?>
            </ul>
        </li>
